...
import com.example.exchangecurrencies.components.Checkbox
...
fun OptionSelector(
  ...
  Column(modifier = modifier.background(ExchangeCurrenciesTheme.colors.backgroundSecondary)) {
    SheetHandle()
...
internal fun OptionSelectorRow(
  ...
  Row(
    ...
    Text(
      ...
      style = ExchangeCurrenciesTheme.typography.caption3,
      text = text,
    )
    if (checked) {
      Checkbox(
