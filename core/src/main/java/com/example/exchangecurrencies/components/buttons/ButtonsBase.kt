...
internal fun ButtonText(
  ...
  Text(
    ...
    style = when (size) {
      ButtonSize.Normal -> ExchangeCurrenciesTheme.typography.button1
      ButtonSize.Small -> ExchangeCurrenciesTheme.typography.button2
    },
    text = text,
  )
}
...
internal object ButtonDefaults {
  ...
  fun primaryButtonColors(): ButtonColors {
    return ButtonColors(
      ...
      contentColor = ExchangeCurrenciesTheme.colors.primaryButton,
      disabledBackgroundColor = ExchangeCurrenciesTheme.colors.textTertiary,
      disabledContentColor = ExchangeCurrenciesTheme.colors.textTertiary,
    )
  }
  ...
  fun secondaryButtonColors(): ButtonColors {
    return ButtonColors(
      backgroundColor = ExchangeCurrenciesTheme.colors.contendSecondary,
      contentColor = ExchangeCurrenciesTheme.colors.textPrimary,
      disabledBackgroundColor = ExchangeCurrenciesTheme.colors.contendSecondary,
      disabledContentColor = ExchangeCurrenciesTheme.colors.textTertiary,
    )
  }
  ...
  fun positiveButtonColors(): ButtonColors {
    return ButtonColors(
      backgroundColor = Color.Transparent,
      contentColor = ExchangeCurrenciesTheme.colors.textPrimary,
      disabledBackgroundColor = ExchangeCurrenciesTheme.colors.contendTertiary,
      disabledContentColor = ExchangeCurrenciesTheme.colors.textTertiary,
    )
  }
  ...
  fun topAppBarButtonColors(
    contentColor: Color = ExchangeCurrenciesTheme.colors.textPrimary,
  ): ButtonColors {
    return ButtonColors(
      backgroundColor = Color.Transparent,
  ...
  fun unselectedChipButtonColors(): ButtonColors {
    return ButtonColors(
      backgroundColor = Color.Transparent,
      contentColor = ExchangeCurrenciesTheme.colors.textSecondary,
      disabledBackgroundColor = Color.Transparent,
      disabledContentColor = ExchangeCurrenciesTheme.colors.textTertiary,
    )
  }
